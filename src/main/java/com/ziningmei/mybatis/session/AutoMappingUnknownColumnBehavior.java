...
public enum AutoMappingUnknownColumnBehavior {
   ...
   * @param propertyType property type for mapping target (If this argument is not null, {@link com.ziningmei.mybatis.type.TypeHandler} for property type is not registered)
     */
