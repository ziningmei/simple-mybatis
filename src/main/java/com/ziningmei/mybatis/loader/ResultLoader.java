...
import com.ziningmei.mybatis.executor.ResultExtractor;
...
public class ResultLoader {
  ...
  public ResultLoader(Configuration config, Executor executor, MappedStatement mappedStatement, Object parameterObject, Class<?> targetType, BoundSql boundSql) {
  ...
  private <E> List<E> selectList() throws SQLException {
    ...
    try {
      return localExecutor.<E> query(mappedStatement, parameterObject, RowBounds.DEFAULT, Executor.NO_RESULT_HANDLER, boundSql);
    } finally {
